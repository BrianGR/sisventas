	...
	<div class="row">
		...
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
				...
				<input type="text" name="direccion" value="{{$persona->direccion}}" class="form-control" placeholder="Direccion cliente...">
			</div>
		</div>
		...
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
				...
				<input type="text" name="telefono" value="{{$persona->telefono}}" class="form-control" placeholder="Telefono cliente...">
			</div>
		</div>
