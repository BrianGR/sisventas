...
<html>
  <head>
    ...
    <title>Sistema de ventas PPE</title>
    ...
    <link rel="apple-touch-icon" href="<?php echo e(asset('img/logo-ppe.png')); ?>">
    <link rel="shortcut icon" href="<?php echo e(asset('img/logo-ppe.png')); ?>">
